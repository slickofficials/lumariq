...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final WireLibraryAccessors laccForWireLibraryAccessors = new WireLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at wire
     */
    public WireLibraryAccessors getWire() {
        return laccForWireLibraryAccessors;
    }
    ...
    public static class WireLibraryAccessors extends SubDependencyFactory {

        public WireLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for grpc (com.squareup.wire:wire-grpc-client)
         * with versionRef 'wire'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getGrpc() {
                return create("wire.grpc");
        }

            /**
             * Creates a dependency provider for runtime (com.squareup.wire:wire-runtime)
         * with versionRef 'wire'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getRuntime() {
                return create("wire.runtime");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: wire (4.9.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getWire() { return getVersion("wire"); }
